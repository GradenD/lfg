<section id="main-slider" class="no-margin">
	<div class="slider">
		<div class="container">
			<div class="description description_shop">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="carousel-caption d-none d-md-block">
								<h1>Special offers</h1>
								<p>X3 MYTHIC+15 TIMED SELFPLAY - +2 FREE TRADERS!</p>
						...
						<div class="carousel-item">
							<div class="carousel-caption d-none d-md-block">
								<h1>Special offers</h1>
								<p>2000 RAIDER.IO SCORE, 465 ITEM LEVEL AND AWAKENED MINDBORER MOUNT!</p>
								<button class="btn btn-outline-secondary btn-lg">See more</button>
							</div>	
						</div>
						<div class="carousel-item">
							<div class="carousel-caption d-none d-md-block">
								<h1>Special offers</h1>
								<p>1200 RAIDER.IO SCORE AND 455 ITEM LEVEL!</p>
								<button class="btn btn-outline-secondary btn-lg">See more</button>
							</div>	
						</div> 
					</div>
...
<div class="container">
	<div class="card-columns block_content">
		<a href="#">
		<div class="card">
			<img class="card-img-top" data-src="img/blog/yed.webp" alt="Card image cap" loading="lazy">
			<div class="card-body">
		...
		<a href="#">
		<div class="card">
			<img class="card-img-top" data-src="img/blog/inmost.webp" alt="Card image cap">
			<div class="card-body">
		...
		<a href="#">
		<div class="card">
			<img class="card-img-top" data-src="img/blog/control.webp" alt="Card image cap">
			<div class="card-body">
				<h5 class="card-title">Card title</h5>
